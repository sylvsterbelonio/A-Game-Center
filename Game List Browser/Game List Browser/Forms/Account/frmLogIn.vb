Public Class frmLogIn
    ...
    Private Sub lnkCreateAccount_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkCreateAccount.LinkClicked
        Dim frm As New frmSignUp
        With frm
            .ShowDialog()
        End With
    End Sub
    ...
    Private Sub My8Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLogIn.Click
        If txtUsername.Text <> "" And txtPassword.Text <> "" Then
            ...
            If mydata.Rows.Count > 0 Then
                ...
                If mydata.Rows.Count > 0 Then
                    userID = mydata.Rows(0).Item("accountID")
                    return_value = "ok"
